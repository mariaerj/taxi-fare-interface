let taxiFareApiUrl = 'https://taxifare-dbspvylqma-ew.a.run.app/predict'; // replace with your API endpoint
...
if (window.location.href.includes('https://taxifare.lewagon.com')) {
  taxiFareApiUrl = 'https://taxifare-dbspvylqma-ew.a.run.app/predict';
}
